  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // *:min-w-0 lets grid children shrink so descendant `truncate`
          // works — without it, long unbreakable content (e.g. a long signing
          // URL) blows past the dialog's max-width. See ShareLinks compact.
