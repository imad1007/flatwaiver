...
- **At the very bottom, flat pricing ties the cheapest tiers.** Smartwaiver Basic, WaiverSign Growth, and WaiverFile Startup all cost $19/month at ~100 waivers — the same as flat $19. The difference is what happens next: their price climbs as you grow, flat's doesn't. (For near-zero volume, WaiverForever's free plan can still beat any paid plan.)
- **The moment you pass ~100 waivers a month, flat wins outright.** Every volume-priced tool jumps to its next tier while flat $19 stays put — and the gap widens every month you grow.
- **At real high-volume numbers, the difference is a staff shift per month.** $199 vs. $19 is $2,160 a year — for the identical job of getting a signature on the same legal text.
