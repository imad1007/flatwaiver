...
*Prices from vendor public pricing pages, July 2026 — see the [full comparison with sources](/blog/smartwaiver-alternatives). At very low volume the cheapest entry tiers cost the same $19/mo as flat pricing; climbing gyms with real day-pass traffic are well past that anyway.*

The pattern is the one that matters: at climbing volume, tiered tools cost 8–10× a flat rate, and your best months are your most expensive. A gym's waiver count is its growth chart — pick software that isn't charging you for it. ([Here's the flat plan in full](/#pricing).)
